...
# Build and Push Script for Game Engine Host to Huawei Cloud SWR
...
echo "=========================================="
echo "Building and Pushing Game Engine Host to Huawei Cloud SWR"
echo "=========================================="
echo "Image: ${FULL_IMAGE_NAME}"
echo ""

# Step 1: Build the Docker image
# Note: Dockerfile expects to be run from GameEngineHost/ directory
echo "Step 1: Building Docker image..."
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
cd "$SCRIPT_DIR"
echo "Building from directory: $(pwd)"
docker build -f Dockerfile -t ${FULL_IMAGE_NAME} -t ${SWR_REPO}:latest .
echo "✅ Build complete"
echo ""
